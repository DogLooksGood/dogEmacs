...
(defun +enable-sql-auto-uppercase-keyword ()
  (interactive)
  (add-hook 'post-self-insert-hook #'+uppercase-sql-keyword t t)
  (modify-syntax-entry ?_ "w")
  (modify-syntax-entry ?- "w"))

(add-hook 'sql-mode-hook #'+enable-sql-auto-uppercase-keyword)
